  ...
  const addItemToCart = async (
    ...
    if (window.dataLayer) {
      ...
      window.dataLayer.push({
        ...
        currency: "USD",
        value:
          response.cartLinesAdd.cart.lines.edges[0].node.merchandise.priceV2
            .amount,
        user_data: {
        ...
        items: [
          {
            item_id:
              response.cartLinesAdd.cart.lines.edges[0].node.merchandise.product
                .id,
            item_name:
              response.cartLinesAdd.cart.lines.edges[0].node.merchandise.product
                .title,
            ...
            quantity: 1,
            item_variant:
              response.cartLinesAdd.cart.lines.edges[0].node.merchandise.title,
          },
        ],
      });
    }
